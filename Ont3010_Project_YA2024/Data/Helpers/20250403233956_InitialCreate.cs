        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasBeenRepairedBefore = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    TechnicianDiagnosis = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AppointmentDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EstimatedRepairDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reports_Fridges_FridgeId_SerialNumber",
                        columns: x => new { x.FridgeId, x.SerialNumber },
                        principalTable: "Fridges",
                        principalColumns: new[] { "FridgeId", "SerialNumber" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FaultTechs", x => x.TechnicianId);
                    table.ForeignKey(
                        name: "FK_FaultTechs_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FaultTechs_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FaultTechs_CustomerId",
                table: "FaultTechs",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_FaultTechs_ReportId",
                table: "FaultTechs",
                column: "ReportId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_FridgeId_SerialNumber",
                table: "Reports",
                columns: new[] { "FridgeId", "SerialNumber" });
