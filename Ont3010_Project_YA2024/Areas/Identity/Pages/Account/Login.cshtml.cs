    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if ((employee == null || employee.IsDeleted) && (customer == null ))
                // Check if the employee exists and is not deleted
                if (employee != null && employee.IsDeleted)

                {
                    ModelState.AddModelError(string.Empty, "This employee account is no longer active.");
                    await SetLayoutData();
                    return Page();
                }
                ...
                {
                    ModelState.AddModelError(string.Empty, "This customer account is no longer active.");
                    await SetLayoutData();
                    return Page();
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return LocalRedirect("~/CustomerLiaison/Dashboard");
                    }
